 ...
 */
public class AmbasadorKlient extends NullFederateAmbassador {
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    //                   INSTANCE VARIABLES
    //----------------------------------------------------------
    private FederatKlient federate;
    ...
    public AmbasadorKlient( FederatKlient federate )
    {
    ...
    {
        System.out.println( "AmbasadorKlient: " + message );
    }
